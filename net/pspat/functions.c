...
static struct sk_buff *pspat_arb_get_skb(struct pspat *arb, struct pspat_queue *pq)
{
    struct pspat_mailbox *m;
    struct sk_buff *skb;
...
static inline void pspat_mark(struct list_head *active_queues, struct sk_buff *skb)
{
